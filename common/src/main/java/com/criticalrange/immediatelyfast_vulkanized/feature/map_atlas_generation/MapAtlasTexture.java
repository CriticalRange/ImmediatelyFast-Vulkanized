 ...
 */
package com.criticalrange.immediatelyfast_vulkanized.feature.map_atlas_generation;
...
public class MapAtlasTexture implements AutoCloseable {
    ...
    public MapAtlasTexture(final int id) {
        ...
        this.identifier = Identifier.of("immediatelyfast_vulkanized", "map_atlas/" + id);
