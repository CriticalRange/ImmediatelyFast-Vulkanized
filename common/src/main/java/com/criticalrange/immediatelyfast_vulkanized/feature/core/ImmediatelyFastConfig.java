 ...
 */
package com.criticalrange.immediatelyfast_vulkanized.feature.core;
...
public class ImmediatelyFastConfig {
    ...
    // VulkanMod compatibility config values
    private String VULKANMOD_INFO = "----- VulkanMod compatibility config values below -----";
    public boolean vulkanmod_disable_opengl_optimizations = true;
    public boolean vulkanmod_enable_safe_texture_optimizations = false;
    public boolean vulkanmod_enable_safe_text_optimizations = false;
